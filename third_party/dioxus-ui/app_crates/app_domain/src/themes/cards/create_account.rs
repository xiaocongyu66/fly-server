...
#[component]
pub fn CardCreateAccount() -> Element {
    rsx! {
        Card {
            CardHeader {
            ...
            CardContent { class: "flex flex-col gap-4",
                ...
                div { class: "relative",
                    ...
                    div { class: "flex relative justify-center text-xs uppercase",
                        span { class: "px-2 bg-background text-muted-foreground", "Or continue with" }
                    }
                }
                form { class: "flex flex-col gap-4",
                    div { class: "flex flex-col gap-3",
                        Label { html_for: "email-create-account", "Email" }
                        Input {
                    ...
                    div { class: "flex flex-col gap-3",
                        Label { html_for: "password-create-account", "Password" }
                        Input {
...
#[component]
pub fn LogoGithub() -> Element {
    rsx! {
        svg { view_box: "0 0 438.549 438.549", class: "mr-2 size-4",
            path {
                fill: "currentColor",
...
#[component]
pub fn LogoGoogle() -> Element {
    rsx! {
        svg { role: "img", view_box: "0 0 24 24", class: "mr-2 size-4",
            path {
                fill: "currentColor",
