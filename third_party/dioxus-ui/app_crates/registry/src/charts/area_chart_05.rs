...
pub fn AreaChart05() -> Element {
    ...
    let series_names = serde_json::to_string(&["Desktop", "Mobile"]).unwrap_or_default();
        ...
        div { class: "flex relative flex-col rounded-xl border transition-all duration-200 ease-in-out hover:z-30 group",
            ...
            Card { class: "gap-0 py-0 rounded-none border-0 shadow-none",
                CardHeader { class: "py-6",
                    ...
                    CardDescription { "Showing desktop and mobile visitors" }
                }
                CardContent { class: "px-2",
                    AreaChart { class: "h-[250px]", json_values, json_labels, series_names }
                }
